...
const Navbar = () => {
   return (
      ...
      <header class="text-gray-400 bg-gray-900 body-font ">
         <div class="container justify-start items-left flex flex-wrap p-5 flex-col md:flex-row">
            <nav class="flex lg:w-2/5 flex-wrap items-start justify-left text-base md:ml-auto ">
